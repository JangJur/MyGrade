...
public class OfferDAO {
	...
	public int getCreditByDivide(String divide) {
		String sqlStatement = "select sum(credit) from offers where divide=? and take_year != 2019";
		
		return jdbcTemplate.queryForObject(sqlStatement, new Object[] {divide}, Integer.class);
	}
	
	public int getTotalCredit() {
		String sqlStatement = "select sum(credit) from offers where take_year != 2019";
		
		return jdbcTemplate.queryForObject(sqlStatement, Integer.class);
	}
	
	public List<Offer> getRegisterOffer() {
		String sqlStatement = "select * from offers where take_year=2019 and semester=1";
